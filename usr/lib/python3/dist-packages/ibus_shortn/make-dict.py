...
russian=language(
    ...
    { "a": "A", "b": "B", "c": "C", "d": "D", "e": "E", "f": "F", "g": "G", "h": "H", "i": "I", "j": "J", "k": "K", "l": "L", "m": "M", "n": "N", "o": "O","p": "P", "q": "Q", "r": "R", "s": "S", "t": "T","u": "U", "v": "V", "w": "W", "x": "X", "y": "Y", "z": "Z", "'":"'", " ": " ","ö":"Ö","ä":"Ä","ü":"Ü","ï":"Ï","ë":"Ë","ù":"Ù","è":"È","à":"À","ç":"Ç","ô":"Ô","â":"Â","ê":"Ê","î":"Î","û":"Û","é":"É" },
    {"A": "a", "B": "b", "C": "c", "D": "d", "E": "e", "F": "f", "G": "g", "H": "h", "I": "i", "J": "j", "K": "k", "L": "l", "M": "m", "N": "n", "O": "o", "P": "p", "Q": "q", "R": "r", "S": "s", "T": "t","U": "u", "V": "v", "W": "w", "X": "x", "Y": "y","Z": "z", "'": "'", " ": " ", "Ö":"ö","Ä":"ä","Ü":"ü","Ï":"ï","Ë":"ë","Ù":"ù","È":"è","À":"à","Ç":"ç","Ô":"ô","Â":"â","Ê":"ê","Î":"î","Û":"û","É":"é"},
    lambda x : russian.encoding(x, {"ö":"O", "ä":"A", "ü":"U", "ï":"I", "ë":"E", "ù":"Y", "è":"R", "à":"W", "ç":"C", "ô":"K", "â":"S", "ê":"F", "î":"V", "û":"N", "é":"M"}),
    lambda x : russian.decoding(x, {"O":"ö", "A":"ä", "U":"ü", "I":"ï", "E":"ë", "Y":"ù", "R":"è", "W":"à", "C":"ç", "K":"ô", "S":"â", "F":"ê", "V":"î", "N":"û", "M":"é"}),
    {"a","e","O","i","o","u","I","E","U","A","y"},
    {"?", "!", ".", ";", ","},
    "ru-dic.json"
    )
...
б в г д ж з к л м н п р с т ф х ц ч ш щ а е ё и о у ы э ю я й ъ ь
Б В Г Д Ж З К Л М Н П Р С Т Ф Х Ц Ч Ш Щ А Е Ё И О У Ы Э Ю Я Й Ъ Ь
b v g d j z k l m n p r s t f h c C w W a e O i o u I E U A y Q q
зхцвбнмлкйчгфдсапоиуытрежяюёъь
ЗХЦВБНМЛКЙЧГФДСАПОИУЫТРЕЖЯЮЁЪЬ
zhcvbnmlkyCgfdsapoiuItpejAUOZX
