# Copyright (c) The IBus Shortn authors
#
# This file is part of ibus-shortn, the IBus Shortn input method engine.
#
...
class Setup(object):
    def __init__ (self, engine, datadir, gettext_package):
        self.settings = Gio.Settings("org.shortn-scheme.ibus.%s" % engine)
        ...
        if engine == "shortn":
            title = dgettext(gettext_package, "Shortn Preferences")
        elif engine == "shortnfr":
            title = dgettext(gettext_package, "Shortnfr Preferences")
